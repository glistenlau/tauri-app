...
export type DbExplainQueryQuery = { __typename?: "Query" } & {
  dbExplain: Array<
    { __typename?: "ExplainRow" } & {
      children?: Maybe<
        Array<{ __typename?: "ExplainRow" } & DbExplainRowFieldsFragment>
      >;
    } & DbExplainRowFieldsFragment
  >;
};

export type DbExplainRowFieldsFragment = { __typename?: "ExplainRow" } & Pick<
  ExplainRow,
  | "id"
  | "operation"
  | "level"
...
export type DbSchemaSearchQuery = { __typename?: "Query" } & {
  dbSchemas: Array<
    { __typename?: "SchemaFile" } & Pick<SchemaFile, "path"> & {
        root: { __typename?: "TreeNode" } & DbSchemaTreeNodeFieldsFragment &
          DbSchemaTreeNodeRecursiveFragment;
      }
  >;
};

export type DbSchemaTreeNodeRecursiveFragment = { __typename?: "TreeNode" } & {
  children: Array<
    { __typename?: "TreeNode" } & {
      children: Array<
        { __typename?: "TreeNode" } & DbSchemaTreeNodeFieldsFragment
      >;
    } & DbSchemaTreeNodeFieldsFragment
  >;
};

export type DbSchemaTreeNodeFieldsFragment = { __typename?: "TreeNode" } & Pick<
  TreeNode,
  "tagName" | "nameAttr" | "dbFamily"
> & {
    values: Array<
      { __typename?: "NodeValue" } & Pick<
        NodeValue,
        "start" | "end" | "dbFamily"
      >
    >;
...
export type DbSchemaSearchFlatQuery = { __typename?: "Query" } & {
  dbSchemasFlat: Array<
    { __typename?: "FlatSchemaFile" } & Pick<FlatSchemaFile, "path"> & {
        nodes: Array<
          { __typename?: "FlatNode" } & Pick<
            FlatNode,
            | "id"
            | "tagName"
            | "nameAttr"
...
export type DbSchemaFileContetQuery = { __typename?: "Query" } & Pick<
  Query,
  "dbSchemaFileContent"
>;
...
export type SubSubscription = { __typename?: "Subscription" } & Pick<
  Subscription,
  "integers"
>;
 ...
 * });
 */
export function useDbExplainQueryQuery(
  baseOptions: Apollo.QueryHookOptions<
    DbExplainQueryQuery,
    DbExplainQueryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DbExplainQueryQuery, DbExplainQueryQueryVariables>(
    DbExplainQueryDocument,
    options
  );
}
export function useDbExplainQueryLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DbExplainQueryQuery, DbExplainQueryQueryVariables>(
    DbExplainQueryDocument,
    options
  );
}
export type DbExplainQueryQueryHookResult = ReturnType<
  typeof useDbExplainQueryQuery
>;
export type DbExplainQueryLazyQueryHookResult = ReturnType<
  typeof useDbExplainQueryLazyQuery
>;
export type DbExplainQueryQueryResult = Apollo.QueryResult<
  DbExplainQueryQuery,
  DbExplainQueryQueryVariables
>;
 ...
 * });
 */
export function useDbSchemaSearchQuery(
  baseOptions: Apollo.QueryHookOptions<
    DbSchemaSearchQuery,
    DbSchemaSearchQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DbSchemaSearchQuery, DbSchemaSearchQueryVariables>(
    DbSchemaSearchDocument,
    options
  );
}
export function useDbSchemaSearchLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DbSchemaSearchQuery,
    DbSchemaSearchQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DbSchemaSearchQuery, DbSchemaSearchQueryVariables>(
    DbSchemaSearchDocument,
    options
  );
}
export type DbSchemaSearchQueryHookResult = ReturnType<
  typeof useDbSchemaSearchQuery
>;
export type DbSchemaSearchLazyQueryHookResult = ReturnType<
  typeof useDbSchemaSearchLazyQuery
>;
export type DbSchemaSearchQueryResult = Apollo.QueryResult<
  DbSchemaSearchQuery,
  DbSchemaSearchQueryVariables
>;
 ...
 * });
 */
export function useDbSchemaSearchFlatQuery(
  baseOptions: Apollo.QueryHookOptions<
    DbSchemaSearchFlatQuery,
    DbSchemaSearchFlatQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    DbSchemaSearchFlatQuery,
    DbSchemaSearchFlatQueryVariables
  >(DbSchemaSearchFlatDocument, options);
}
export function useDbSchemaSearchFlatLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DbSchemaSearchFlatQuery,
    DbSchemaSearchFlatQueryVariables
  >
...
export type DbSchemaSearchFlatQueryHookResult = ReturnType<
  typeof useDbSchemaSearchFlatQuery
>;
export type DbSchemaSearchFlatLazyQueryHookResult = ReturnType<
  typeof useDbSchemaSearchFlatLazyQuery
>;
export type DbSchemaSearchFlatQueryResult = Apollo.QueryResult<
  DbSchemaSearchFlatQuery,
  DbSchemaSearchFlatQueryVariables
>;
 ...
 * });
 */
export function useDbSchemaFileContetQuery(
  baseOptions: Apollo.QueryHookOptions<
    DbSchemaFileContetQuery,
    DbSchemaFileContetQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    DbSchemaFileContetQuery,
    DbSchemaFileContetQueryVariables
  >(DbSchemaFileContetDocument, options);
}
export function useDbSchemaFileContetLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DbSchemaFileContetQuery,
    DbSchemaFileContetQueryVariables
  >
...
export type DbSchemaFileContetQueryHookResult = ReturnType<
  typeof useDbSchemaFileContetQuery
>;
export type DbSchemaFileContetLazyQueryHookResult = ReturnType<
  typeof useDbSchemaFileContetLazyQuery
>;
export type DbSchemaFileContetQueryResult = Apollo.QueryResult<
  DbSchemaFileContetQuery,
  DbSchemaFileContetQueryVariables
>;
 ...
 * });
 */
export function useSubSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    SubSubscription,
    SubSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<SubSubscription, SubSubscriptionVariables>(
    SubDocument,
    options
  );
}
